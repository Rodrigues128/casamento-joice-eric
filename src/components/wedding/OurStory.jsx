        ...
        <div className="flex flex-col md:flex-row gap-12 items-center">
          ...
          <motion.div className="w-full md:w-1/2 relative"
            ...
            <div className="relative aspect-[4/5] overflow-hidden rounded-3xl shadow-2xl">
              <img src={couplePhoto} alt="Momentos" className="w-full h-full object-cover" loading="lazy" />
          ...
          <motion.div className="w-full md:w-1/2 space-y-6"
            ...
            <p className="font-body text-wine/70 text-lg leading-relaxed first-letter:text-4xl first-letter:font-display first-letter:mr-2 first-letter:float-left">
              Nossa história começou de forma simples e inusitada, em uma rodoviária e nem imaginávamos que, ali, o destino já tinha planos maiores para nós. O que começou com conversas aleatórias logo se transformou em uma conexão profunda e inabalável.
            </p>
            <p className="font-body text-wine/70 text-lg leading-relaxed">
              Cada momento, cada risada compartilhada e cada desafio superado nos trouxe até aqui. Descobrimos, um no outro, não apenas o amor, mas também melhores amigos e um verdadeiro companheirismo.
            </p>
            <div className="pt-4">
